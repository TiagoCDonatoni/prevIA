...
from src.odds.jobs.odds_refresh_resolve_job import _client, _persist_odds_h2h_batch  # reuse interno (sem duplicar SQL)
...
def odds_refresh(
    *,
    ...
    """
    try:
        raw: List[Dict[str, Any]] = _client().get_odds_h2h(sport_key=sport_key, regions=regions)
