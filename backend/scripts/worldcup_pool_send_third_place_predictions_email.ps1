...
# powershell -ExecutionPolicy Bypass -File scripts\worldcup_pool_send_third_place_predictions_email.ps1 -Send
...
$env:REQUESTED_BY = if ($dryRun) {
    "manual_third_place_predictions_email_dry_run"
} else {
    "manual_third_place_predictions_email_send"
}
...
$env:PAYLOAD_JSON = @"
{
  ...
  "phase": "third_place",
  "notification_key": "fifa_world_cup_2026:third_place:predictions_open:v1",
  "dry_run": $dryRunJson,
  "force": false,
  "limit": 1000,
  "stage_label_pt": "a disputa de 3º lugar",
  "stage_label_en": "the third-place match",
  "stage_label_es": "el partido por el 3º puesto"
}
"@
