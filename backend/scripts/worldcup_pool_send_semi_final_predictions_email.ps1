...
# powershell -ExecutionPolicy Bypass -File scripts\worldcup_pool_send_semi_final_predictions_email.ps1 -Send
...
$env:REQUESTED_BY = if ($dryRun) {
    "manual_semi_final_predictions_email_dry_run"
} else {
    "manual_semi_final_predictions_email_send"
}
...
$env:PAYLOAD_JSON = @"
{
  ...
  "phase": "semi_final",
  "notification_key": "fifa_world_cup_2026:semi_final:predictions_open:v1",
  "dry_run": $dryRunJson,
  "force": false,
  "limit": 1000,
  "stage_label_pt": "as semifinais",
  "stage_label_en": "the semi-finals",
  "stage_label_es": "las semifinales"
}
"@
