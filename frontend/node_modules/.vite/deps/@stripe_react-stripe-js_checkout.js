...
var getContextValue = function getContextValue2(stripe, state) {
  if (state.type === "success") {
    var sdk = state.sdk, session = state.session;
    sdk.on;
    sdk.session;
...
var CheckoutProvider = function CheckoutProvider2(_ref) {
  ...
  import_react.default.useEffect(function() {
    ...
    var init = function init2(_ref2) {
      ...
      if (stripe2 && isMounted && !initCheckoutCalledRef.current) {
        ...
        stripe2.initCheckout(options).then(function(sdk2) {
          setState({
            type: "success",
            sdk: sdk2,
            session: sdk2.session()
          });
          sdk2.on("change", function(session) {
  ...
  import_react.default.useEffect(function() {
    ...
    var hasSdkLoaded = Boolean(!prevCheckoutSdk && sdk);
